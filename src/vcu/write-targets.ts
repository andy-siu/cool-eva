...
export const WRITE_TARGETS: WriteTarget[] = [
  {
    ...
    // scaling anywhere (obd-garage/SERVICE_TOOL_2024.md), and 75 appears verbatim as
    ...
    // separate the service tool builds. It is worth noting how unusual that is in the option
  ...
  },
  {
    ...
    // option, it does not appear in the service tool 2021 or 2024 by name, this bike's firmware
  ...
  },
  {
    ...
    // Bit map from Energica's own option data (obd-garage/SERVICE_TOOL_2024.md), decode
