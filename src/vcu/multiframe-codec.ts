...
//     `33 FE` polled) is the service tool's freeze-frame ERASE, and it is the thing that
 ...
 *
 * ⚠️ SERVICE_TOOL_2024.md §7.2 calls this a `0x31` routine id. It is not: it is the
 ...
 *
 * ⚠️ The LAYOUT is decompiled from the service tool's decoder, not captured: `58 <count>`
 ...
 * which the second owner's tool documents identically (the service tool "unconditionally
