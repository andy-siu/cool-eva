...
//                The fix is scripts/extract-vcu-tables.ts against your own the service tool
...
function describeMismatchRemedy(indices: number[]): string {
  ...
  return (
    ...
    "`node --experimental-strip-types scripts/extract-vcu-tables.ts <your the service-tool executable>` against your own Energica " +
