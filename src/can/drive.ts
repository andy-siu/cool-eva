...
// Energica's `FramesDB` (obd-garage/SERVICE_TOOL_2024.md); 0x125 and 0x127 are not in it at all
...
//  1. Energica states it outright. `the telemetry table` carries
...
//     the two files have to be read together. See obd-garage/SERVICE_TOOL_2024.md §6.0.)
